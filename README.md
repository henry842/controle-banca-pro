...
Bankroll management, operational control and performance tracking. This project was organized as a portfolio-ready case study: it explains the objective, the analytical path, the visual evidence and the practical interpretation behind the result.

Main objective: Support bankroll control with clear metrics, structured records and practical decision rules.

**PT-BR**

Gestao de banca, controle operacional e acompanhamento de desempenho. Este projeto foi organizado como um estudo de caso pronto para portfolio: explica o objetivo, o caminho analitico, as evidencias visuais e a interpretacao pratica por tras do resultado.

Objetivo principal: Apoiar controle de banca com metricas claras, registros estruturados e regras praticas de decisao.
